...
public class StudentDetails extends JFrame implements ActionListener {//Click Event on the   JButton search,print,update,add,cancel;//For making button to use this 
   ...
   //ddropDwon
    ...
    public void actionPerformed(ActionEvent ae)//Overriding function
    {
        ...
        {
            String query="select * from uustudent where rollno='"+crollno.getSelectedItem()+"'";
            try{
                Conn c=new Conn();
    ...
    {
        new StudentDetails();//Class object
    }
