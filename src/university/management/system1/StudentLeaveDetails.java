...
public class StudentLeaveDetails extends JFrame implements ActionListener {//Click Event on the   JButton search,print,update,add,cancel;//For making button to use this 
   ...
   //ddropDwon
    ...
    StudentLeaveDetails()//Constructor
    ...
    {
        new StudentLeaveDetails();//Class object
    }
